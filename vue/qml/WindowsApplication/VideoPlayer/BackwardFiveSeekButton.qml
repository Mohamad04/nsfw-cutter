...
Button {
    ...
    Accessible.name: qsTr("Seek backward 5 seconds")
    ...
    contentItem: Canvas {
        ...
        onPaint: {
            ...
            iconCanvas.roundedRect(ctx, 10.8, 12.2, 20.4, 12.6, 4.3, scale, offsetX, offsetY)
            ...
            var streak = ctx.createLinearGradient(iconCanvas.mapX(28.6, scale, offsetX), 0,
                                                  iconCanvas.mapX(33.8, scale, offsetX), 0)
            streak.addColorStop(0.0, light ? "rgba(37, 99, 235, 0.22)" : "rgba(255, 255, 255, 0.82)")
            streak.addColorStop(0.45, light ? (active ? "rgba(37, 99, 235, 0.20)" : "rgba(37, 99, 235, 0.10)") : (active ? "rgba(115, 218, 255, 0.78)" : "rgba(88, 190, 255, 0.32)"))
            streak.addColorStop(1.0, light ? "rgba(37, 99, 235, 0.0)" : "rgba(91, 190, 255, 0.0)")
